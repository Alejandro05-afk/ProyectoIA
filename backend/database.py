...
#MONGODB_URL = os.getenv("MONGODB_URL", "mongodb://localhost:27017")  # Conexión a MongoDB LOCAL por defecto
MONGODB_URL = "mongodb+srv://kogamaandres_db_user:fwsAYpZWhHb6Anq1@electroshop.q0k2ovr.mongodb.net/electroshop?retryWrites=true&w=majority"  # Conexión a MongoDB ATLAS
